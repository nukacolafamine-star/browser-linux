...
import {KERNEL_FIX} from './kernel-fix.mjs';
...
const provenance={
 project:'Browser Linux',version:'0.1.1',
 ...
 kernelTransformation:{debugMetadata:'Remove .debug_* custom sections.',compatibility:KERNEL_FIX,source:'tools/kernel-fix.mjs'},files,
